...
.factory('EmployeeService', function($q, $http) {
    ...
    var members = ["aidi", "miaojian", "yaoyi", "huwei", "yongqianying", "xinxing", "huangjunlin", "xubowen", "bubu", "haijun", "yonasliu", "hongfei", "barry.wu", "jerry", "hidecloud", "duanwan", "liuxv", "zanzhi", "guochao", "xiaocun", "wumengqi", "cuiqiu", "zhuliangliang", "zhuwenjie", "zhangchangyi", "neozhang", "luolisi", "huyue", "yangyapeng", "yulingxiao", "machao", "beichen", "bruce.bai"];
